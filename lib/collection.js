...
Collection.prototype.insert = function(document, callback) {
	...
	try{
		...
		console.log('Number of documents before insert: ' + this._documents.length);
...
Collection.prototype.save = function(document, callback) {
	var err, ids, stored;
	console.log('Number of documents before save: ' + this._documents.length);
	if(!_.has(document, '_id')) {
...
Collection.prototype.find = function(query){
	...
	console.log('Found number of documents: ' + foundDocuments.length);
