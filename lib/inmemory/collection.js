...
Collection.prototype._write = function (op, documents, callback) {
...
Collection.prototype.insert = function (documents, callback) {
  return this._write('insert', documents, callback);
};

Collection.prototype.save = function (documents, callback) {
  return this._write('save', documents, callback);
};
